...
@Repository
@Transactional
public class CommodityCategoryDaoImpl extends GenericDaoHibernate<Commoditycategory, Long> implements ICommodityCategoryDao {

    private static final String identityKey = Commoditycategory.PROPERTYNAME_COMMODITY_CATEGORY_ID;

    public CommodityCategoryDaoImpl() {
        super(Commoditycategory.class);
    }
    ...
    public List getList(String orderColumn, boolean ifDesc, int start, int offset, List<Long> receivedIds) {
        DetachedCriteria query = DetachedCriteria.forClass(Commoditycategory.class);
