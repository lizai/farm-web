...
@Repository
@Transactional
public class DishTypeDaoImpl extends GenericDaoHibernate<Dishtype, Long> implements IDishTypeDao {

    private static final String identityKey = Dishtype.PROPERTYNAME_DISH_TYPE_ID;
    ...
    @Override
    public void saveOrUpdateEntity(Dishtype book) {
    ...
    public List getList(String orderColumn, boolean ifDesc, int start, int offset, List<Long> receivedIds) {
        DetachedCriteria query = DetachedCriteria.forClass(Dishtype.class);
