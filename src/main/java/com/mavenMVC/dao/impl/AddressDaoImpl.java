...
@Repository
@Transactional
public class AddressDaoImpl extends GenericDaoHibernate<Address, Long> implements IAddressDao {

    private static final String identityKey = Address.PROPERTYNAME_ADDRESS_ID;
    ...
    @Override
    public void saveOrUpdateEntity(Address address) {
    ...
    public List getList(String orderColumn, boolean ifDesc, int start, int offset, List<Long> receivedIds) {
        DetachedCriteria query = DetachedCriteria.forClass(Address.class);
