...
@Repository
@Transactional
public class BookDaoImpl extends GenericDaoHibernate<Book, Long> implements IBookDao {

    private static final String identityKey = Book.PROPERTYNAME_BOOK_ID;
    ...
    @Override
    public void saveOrUpdateEntity(Book book) {
