...
@Repository
@Transactional
public class QueueDaoImpl extends GenericDaoHibernate<Queue, Long> implements IQueueDao {

    private static final String identityKey = Queue.PROPERTYNAME_QUEUE_ID;
    ...
    @Override
    public void saveOrUpdateEntity(Queue book) {
