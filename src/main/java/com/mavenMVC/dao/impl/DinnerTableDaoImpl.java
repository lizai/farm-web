...
import com.mavenMVC.dao.IDinnerTableDao;
import com.mavenMVC.entity.Dinnertable;
...
@Repository
@Transactional
public class DinnerTableDaoImpl extends GenericDaoHibernate<Dinnertable, Long> implements IDinnerTableDao {

    private static final String identityKey = Dinnertable.PROPERTYNAME_TABLE_ID;

    public DinnerTableDaoImpl() {
    ...
    @Override
    public void saveOrUpdateEntity(Dinnertable book) {
    ...
    public List getList(String orderColumn, boolean ifDesc, int start, int offset, List<Long> receivedIds) {
        DetachedCriteria query = DetachedCriteria.forClass(Dinnertable.class);
