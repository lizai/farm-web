...
import com.mavenMVC.dao.IAdminRoleDao;
import com.mavenMVC.entity.Adminrole;
...
@Repository
@Transactional
public class AdminRoleDaoImpl extends GenericDaoHibernate<Adminrole, Long> implements IAdminRoleDao {

    private static final String identityKey = Adminrole.PROPERTYNAME_ADMIN_ROLE_ID;
    ...
    @Override
    public void saveOrUpdateEntity(Adminrole address) {
    ...
    public List getList(String orderColumn, boolean ifDesc, int start, int offset, List<Long> receivedIds) {
        DetachedCriteria query = DetachedCriteria.forClass(Adminrole.class);
